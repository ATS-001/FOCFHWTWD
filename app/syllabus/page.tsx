  ...
  return (
    <div className="min-h-screen bg-th-bg relative">
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="md:hidden flex items-center justify-between p-6 bg-th-bg border-b-2 border-th-border sticky top-0 z-[100]">
          ...
          <button 
            ...
            className="p-3 bg-th-bg-secondary text-th-text border-2 border-th-border hover:bg-th-text hover:text-th-bg transition-colors relative z-[110] cursor-pointer touch-manipulation"
          >
            {isMenuOpen ? <X className="w-5 h-5 pointer-events-none" /> : <MenuIcon className="w-5 h-5 pointer-events-none" />}
          </button>
        </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8">
              {currentMod?.topics.map((topic, index) => (
                <Link 
                  key={topic.name}
                  href={`/syllabus/${activeModule}/${index}`}
