      ...
      <main className="max-w-6xl mx-auto px-6 pt-12 pb-40 md:py-20 lg:grid lg:grid-cols-[1fr_300px] lg:gap-16">
        ...
        >
          ...
          <section className="prose prose-slate prose-lg md:prose-xl max-w-none 
            ...
            prose-table:w-full prose-table:border-2 prose-table:border-th-border prose-thead:border-b-2 prose-thead:border-th-border
            prose-tr:border-b prose-tr:border-th-border/20 prose-th:border-r prose-th:border-th-border/20 prose-th:p-3 prose-th:bg-th-bg-secondary prose-th:text-th-text
            prose-td:border-r prose-td:border-th-border/20 prose-td:p-3 prose-td:text-th-text-secondary">
          ...
          <footer className="mt-24 mb-32 md:mb-16 pt-12 border-t-4 border-th-border grid grid-cols-1 md:grid-cols-2 gap-px bg-th-border rounded-sm overflow-hidden">
            <div className="bg-th-bg p-8 md:p-12 min-w-0">
              ...
              >
                ...
                {prevTopic && (
                  <span className="text-2xl md:text-3xl font-black uppercase tracking-tighter group-hover:underline decoration-th-accent underline-offset-8 decoration-4 leading-snug pb-1 break-words w-full">
                    {prevTopic.name}
                  </span>
                )}
              </button>
